...
```{r}
Kalauhaihai_Makaha <- read_csv(here("BB_20970109.csv"))

KanewaiFishpondLedgeEdgeNorfolk <- read_csv(here("GG_20970122.csv"))
  
KanewaiSpringLedge <- read_csv(here("O_20970093.csv"))
  
KanewaiFishpondShade <- read_csv(here("OYG_20970123.csv"))


# IN-LAB CODE

# Here we have imported 4 of the 5 datasets into our environment. Can you use the code above to import the last remaining dataset from the "data/" folder?

# KanewaiAuwaiMakaiSideFootBridge = YG_20970107.csv
...
# We have added location columns to 4 of the 5 dataframes. Can you use the code above to add a location column to the last remaining dataframe (KanewaiAuwaiMakaiSideFootBridge)
